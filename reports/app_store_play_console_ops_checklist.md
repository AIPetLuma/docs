...
- P1 门禁：`docs/reports/p1_release_readiness.md`

## 1. 本地提交前检查

- [x] 已确认 `legal/privacy_policy.md` 与 `legal/terms_of_service.md` 不再使用占位支持邮箱 `support@your-domain.com`
...
- [ ] `docs/reports/p1_release_readiness.md` 中 blocker 已全部关闭
- [ ] `docs/reports/store_listing_copy_template.md` 已从模板替换成真实文案
